...
Use these stable Crew-specific runtime rules in addition to the generic review packs.
...
- It is a stable Crew runtime invariant.
- Generic React, TypeScript, accessibility, crew-ui, query, or performance rules would not catch it.
