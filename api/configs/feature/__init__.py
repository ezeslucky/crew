...
class SecurityConfig(BaseSettings):
    ...
    SECRET_KEY: str = Field(
        ...
        "Leave empty to let Crew generate a persistent key in the storage directory, "
...
class MarketplaceConfig(BaseSettings):
    ...
    MARKETPLACE_API_URL: HttpUrl = Field(
        ...
        default=HttpUrl("https://marketplace.crew.ai"),
    )
...
class CreatorsPlatformConfig(BaseSettings):
    ...
    CREATORS_PLATFORM_API_URL: HttpUrl = Field(
        ...
        default=HttpUrl("https://creators.crew.ai"),
    )
...
class HttpConfig(BaseSettings):
    ...
    OPENAPI_ENABLED: bool = Field(
        description=(
            "Enable the /openapi/v1/* endpoint group used by crewctl and other "
...
class RepositoryConfig(BaseSettings):
    ...
    API_WORKFLOW_NODE_EXECUTION_REPOSITORY: str = Field(
        ...
        default="repositories.sqlalchemy_api_workflow_node_execution_repository.crewAPISQLAlchemyWorkflowNodeExecutionRepository",
    )
    ...
    API_WORKFLOW_RUN_REPOSITORY: str = Field(
        ...
        default="repositories.sqlalchemy_api_workflow_run_repository.crewAPISQLAlchemyWorkflowRunRepository",
    )
...
class RagEtlConfig(BaseSettings):
    ...
    ETL_TYPE: str = Field(
        description="RAG ETL type ('crew' or 'Unstructured'), default to 'crew'",
        default="crew",
    )
