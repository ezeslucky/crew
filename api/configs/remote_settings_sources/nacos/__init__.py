...
class NacosSettingsSource(RemoteSettingsSource):
    ...
    def async_init(self) -> None:
        data_id = os.getenv("CREW_ENV_NACOS_DATA_ID", "crew-api-env.properties")
        group = os.getenv("CREW_ENV_NACOS_GROUP", "nacos-crew")
        tenant = os.getenv("CREW_ENV_NACOS_NAMESPACE", "")
