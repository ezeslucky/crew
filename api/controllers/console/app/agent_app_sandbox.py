...
from crew_agent.client import CrewAgentClientError, CrewAgentHTTPError, CrewAgentTimeoutError
...
def _handle(exc: Exception) -> tuple[dict[str, object], int]:
    ...
    if isinstance(exc, CrewAgentHTTPError):
        detail = exc.detail
    ...
    if isinstance(exc, CrewAgentTimeoutError | CrewAgentClientError):
