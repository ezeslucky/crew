...
class AnnotationBatchImportApi(Resource):
    ...
    def post(self, session: Session, app_id: UUID):
        ...
        max_size_bytes = crew_config.ANNOTATION_IMPORT_FILE_SIZE_LIMIT * 1024 * 1024
        if file_size > max_size_bytes:
            abort(
                413,
                f"File size exceeds maximum limit of {crew_config.ANNOTATION_IMPORT_FILE_SIZE_LIMIT}MB. "
