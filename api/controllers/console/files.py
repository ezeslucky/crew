...
class FileApi(Resource):
    ...
    def get(self):
        config = UploadConfig(
            file_size_limit=crew_config.UPLOAD_FILE_SIZE_LIMIT,
            batch_count_limit=crew_config.UPLOAD_FILE_BATCH_LIMIT,
            file_upload_limit=crew_config.BATCH_UPLOAD_LIMIT,
            image_file_size_limit=crew_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT,
            video_file_size_limit=crew_config.UPLOAD_VIDEO_FILE_SIZE_LIMIT,
            audio_file_size_limit=crew_config.UPLOAD_AUDIO_FILE_SIZE_LIMIT,
            workflow_file_upload_limit=crew_config.WORKFLOW_FILE_UPLOAD_LIMIT,
            image_file_batch_limit=crew_config.IMAGE_FILE_BATCH_LIMIT,
            single_chunk_attachment_limit=crew_config.SINGLE_CHUNK_ATTACHMENT_LIMIT,
            attachment_image_file_size_limit=crew_config.ATTACHMENT_IMAGE_FILE_SIZE_LIMIT,
        )
