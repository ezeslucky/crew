...
class TenantListApi(Resource):
    ...
    def get(self, session: Session, current_tenant_id: str, current_user: Account):
        ...
        tenant_dicts = []
        is_enterprise_only = crew_config.ENTERPRISE_ENABLED and not crew_config.BILLING_ENABLED
        is_saas = crew_config.EDITION == "CLOUD" and crew_config.BILLING_ENABLED
