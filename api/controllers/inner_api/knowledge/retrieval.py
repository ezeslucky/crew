...
It uses the plugin inner API key because crew-agent calls this endpoint through
the same trusted Crew API bridge as other agent/plugin inner calls; tenant-scoped
