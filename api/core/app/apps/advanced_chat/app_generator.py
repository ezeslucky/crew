...
from core.repositories import CrewCoreRepositoryFactory
    ...
    def generate(
        ...
        *,
        ...
        with self._bind_file_access_scope(tenant_id=app_model.tenant_id, user=user, invoke_from=invoke_from):
            ...
            workflow_execution_repository = CrewCoreRepositoryFactory.create_workflow_execution_repository(
            ...
            workflow_node_execution_repository = CrewCoreRepositoryFactory.create_workflow_node_execution_repository(
                session_factory=session_factory,
                tenant_id=app_model.tenant_id,
                user=user,
                app_id=application_generate_entity.app_config.app_id,
