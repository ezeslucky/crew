"""Build crew-agent run requests for one Agent App conversation turn.
...
knowledge config is mapped into the same fixed ``crew.knowledge_base`` layer
...
from core.workflow.nodes.agent_v2.crew_tools_builder import (
...
class AgentAppRuntimeRequestBuilder:
    """Build crew-agent run requests from Agent App conversation state."""
