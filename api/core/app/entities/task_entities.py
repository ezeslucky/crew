...
from core.workflow.nodes.human_input.pause_reason import CrewHITLEventType
...
class HumanInputRequiredPauseReasonPayload(BaseModel):
    ...
    TYPE: Literal[CrewHITLEventType.HUMAN_INPUT_REQUIRED] = CrewHITLEventType.HUMAN_INPUT_REQUIRED
    form_id: str
    node_id: str
    node_title: str
    form_content: str
