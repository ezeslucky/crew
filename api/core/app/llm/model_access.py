...
from core.app.entities.app_invoke_entities import CrewRunContext, ModelConfigWithCredentialsEntity
...
def build_crew_model_access(run_context: CrewRunContext) -> tuple[CredentialsProvider, CrewModelFactory]:
    ...
    return (
        CrewCredentialsProvider(run_context=run_context, provider_manager=provider_manager),
        CrewModelFactory(run_context=run_context, model_manager=model_manager),
    )
...
def fetch_model_config(
    *,
    ...
    model_factory: CrewModelFactory,
    ...
    provider_model = None
    if isinstance(credentials_provider, CrewCredentialsProvider):
