...
# Constants
CLIENT_NAME = "Crew"
CLIENT_URI = "https://github.com/ezeslucky/crew"
...
class IdentityMode(StrEnum):
    """How Crew forwards the end-user's identity to an MCP server."""
...
class MCPProviderEntity(BaseModel):
    ...
    def redirect_url(self) -> str:
        """OAuth redirect URL"""
        return crew_config.CONSOLE_API_URL + "/console/api/mcp/oauth/callback"
