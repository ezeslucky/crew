...
code_execution_endpoint_url = URL(str(crew_config.CODE_EXECUTION_ENDPOINT))
CODE_EXECUTION_SSL_VERIFY = crew_config.CODE_EXECUTION_SSL_VERIFY
_CODE_EXECUTOR_CLIENT_LIMITS = httpx.Limits(
    max_connections=crew_config.CODE_EXECUTION_POOL_MAX_CONNECTIONS,
    max_keepalive_connections=crew_config.CODE_EXECUTION_POOL_MAX_KEEPALIVE_CONNECTIONS,
    keepalive_expiry=crew_config.CODE_EXECUTION_POOL_KEEPALIVE_EXPIRY,
)
...
class CodeExecutor:
    ...
    def execute_code(cls, language: CodeLanguage, preload: str, code: str) -> str:
        ...
        headers = {"X-Api-Key": crew_config.CODE_EXECUTION_API_KEY}
        ...
        timeout = httpx.Timeout(
            connect=crew_config.CODE_EXECUTION_CONNECT_TIMEOUT,
            read=crew_config.CODE_EXECUTION_READ_TIMEOUT,
            write=crew_config.CODE_EXECUTION_WRITE_TIMEOUT,
            pool=None,
        )
