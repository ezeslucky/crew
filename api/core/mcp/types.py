...
"""
# Latest protocol version the Crew MCP client negotiates with upstream MCP servers.
LATEST_PROTOCOL_VERSION = "2025-06-18"
# Latest protocol version the Crew MCP server advertises to connecting clients.
SERVER_LATEST_PROTOCOL_VERSION = "2025-06-18"
# Protocol versions the Crew MCP server can negotiate down to (e.g. Claude on 2024-11-05).
