...
HTTP_REQUEST_NODE_SSL_VERIFY = crew_config.HTTP_REQUEST_NODE_SSL_VERIFY
...
def create_ssrf_proxy_mcp_http_client(
    ...
    elif crew_config.SSRF_PROXY_HTTP_URL and crew_config.SSRF_PROXY_HTTPS_URL:
        proxy_mounts = {
            "http://": httpx.HTTPTransport(proxy=crew_config.SSRF_PROXY_HTTP_URL, verify=HTTP_REQUEST_NODE_SSL_VERIFY),
            "https://": httpx.HTTPTransport(
                proxy=crew_config.SSRF_PROXY_HTTPS_URL, verify=HTTP_REQUEST_NODE_SSL_VERIFY
            ),
        }
        return httpx.Client(
            verify=HTTP_REQUEST_NODE_SSL_VERIFY,
