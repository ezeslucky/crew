        ...
        try:
            match key:
                case TracingProviderEnum.LANGFUSE:
                    from crew_trace_langfuse.config import LangfuseConfig
                    from crew_trace_langfuse.langfuse_trace import LangFuseDataTrace
                ...
                case TracingProviderEnum.LANGSMITH:
                    from crew_trace_langsmith.config import LangSmithConfig
                    from crew_trace_langsmith.langsmith_trace import LangSmithDataTrace
                ...
                case TracingProviderEnum.OPIK:
                    from crew_trace_opik.config import OpikConfig
                    from crew_trace_opik.opik_trace import OpikDataTrace
                ...
                case TracingProviderEnum.WEAVE:
                    from crew_trace_weave.config import WeaveConfig
                    from crew_trace_weave.weave_trace import WeaveDataTrace
                ...
                case TracingProviderEnum.ARIZE:
                    from crew_trace_arize_phoenix.arize_phoenix_trace import ArizePhoenixDataTrace
                    from crew_trace_arize_phoenix.config import ArizeConfig
                ...
                case TracingProviderEnum.PHOENIX:
                    from crew_trace_arize_phoenix.arize_phoenix_trace import ArizePhoenixDataTrace
                    from crew_trace_arize_phoenix.config import PhoenixConfig
                ...
                case TracingProviderEnum.ALIYUN:
                    from crew_trace_aliyun.aliyun_trace import AliyunDataTrace
                    from crew_trace_aliyun.config import AliyunConfig
                ...
                case TracingProviderEnum.MLFLOW:
                    from crew_trace_mlflow.config import MLflowConfig
                    from crew_trace_mlflow.mlflow_trace import MLflowDataTrace
                ...
                case TracingProviderEnum.DATABRICKS:
                    from crew_trace_mlflow.config import DatabricksConfig
                    from crew_trace_mlflow.mlflow_trace import MLflowDataTrace
                ...
                case TracingProviderEnum.TENCENT:
                    from crew_trace_tencent.config import TencentConfig
                    from crew_trace_tencent.tencent_trace import TencentDataTrace
        ...
        if cls._workflow_run_repo is None:
            with cls._repo_lock:
                if cls._workflow_run_repo is None:
                    ...
                    from repositories.factory import CrewAPIRepositoryFactory

                    session_maker = sessionmaker(bind=db.engine, expire_on_commit=False)
                    cls._workflow_run_repo = CrewAPIRepositoryFactory.create_api_workflow_run_repository(session_maker)
