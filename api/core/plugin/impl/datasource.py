...
from core.schemas.resolver import resolve_crew_schema_refs
...
class PluginDatasourceManager(BasePluginClient):
                ...
                for provider in json_response.get("data", []):
                    ...
                    for datasource in declaration.get("datasources", []):
                        ...
                        if datasource.get("output_schema"):
                            datasource["output_schema"] = resolve_crew_schema_refs(datasource["output_schema"])
    ...
    def _get_local_file_datasource_provider(self) -> dict[str, Any]:
        return {
            ...
            "provider": "file",
            "plugin_unique_identifier": "langgenius/file:0.0.1@crew",
            "declaration": {
                "identity": {
                    "author": "langgenius",
                    "name": "file",
                    "label": {"zh_Hans": "File", "en_US": "File", "pt_BR": "File", "ja_JP": "File"},
                    "icon": "https://assets.crew.ai/images/File%20Upload.svg",
