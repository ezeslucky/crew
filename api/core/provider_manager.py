...
class ProviderManager:
    ...
    def get_configurations(self, tenant_id: str) -> ProviderConfigurations:
        ...
        for provider_entity in provider_entities:
            ...
            if is_filtered(
                include_set=crew_config.POSITION_PROVIDER_INCLUDES_SET,
                exclude_set=crew_config.POSITION_PROVIDER_EXCLUDES_SET,
            ...
            elif crew_config.EDITION == "CLOUD" and system_configuration.enabled:
