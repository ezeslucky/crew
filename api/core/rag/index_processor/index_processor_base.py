...
class BaseIndexProcessor(ABC):
    ...
    def _get_splitter(
        ...
        if processing_rule_mode in ["custom", "hierarchical"]:
            ...
            max_segmentation_tokens_length = crew_config.INDEXING_MAX_SEGMENTATION_TOKENS_LENGTH
    ...
    def _download_image(self, image_url: str, current_user: Account) -> str | None:
        ...
        MAX_IMAGE_SIZE = crew_config.ATTACHMENT_IMAGE_FILE_SIZE_LIMIT * 1024 * 1024
        DOWNLOAD_TIMEOUT = crew_config.ATTACHMENT_IMAGE_DOWNLOAD_TIMEOUT
