...
class CrewCoreRepositoryFactory:
    """
    ...
    def create_workflow_execution_repository(
        ...
        """
        class_path = crew_config.CORE_WORKFLOW_EXECUTION_REPOSITORY
    ...
    def create_workflow_node_execution_repository(
        ...
        Raises:
            RepositoryImportError: If the configured repository cannot be created
        """
        class_path = crew_config.CORE_WORKFLOW_NODE_EXECUTION_REPOSITORY
