...
class SQLAlchemyWorkflowNodeExecutionRepository(WorkflowNodeExecutionRepository):
    ...
    def _create_truncator(self) -> VariableTruncator:
        return VariableTruncator(
            max_size_bytes=crew_config.WORKFLOW_VARIABLE_TRUNCATION_MAX_SIZE,
            array_element_limit=crew_config.WORKFLOW_VARIABLE_TRUNCATION_ARRAY_LENGTH,
            string_length_limit=crew_config.WORKFLOW_VARIABLE_TRUNCATION_STRING_LENGTH,
        )
