...
FORWARDED_IDENTITY_HEADER = "X-Crew-SSO-Token"
...
class MCPTool(Tool):
    ...
    def _forwarding_requested(self) -> bool:
        ...
        return self.identity_mode != IdentityMode.OFF and crew_config.ENTERPRISE_ENABLED
    ...
    def invoke_remote_mcp_tool(
        ...
        # untouched. The MCP server is expected to read X-Crew-SSO-Token
