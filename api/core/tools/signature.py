...
def sign_tool_file(tool_file_id: str, extension: str, for_external: bool = True) -> str:
    ...
    base_url = crew_config.FILES_URL if for_external else (crew_config.INTERNAL_FILES_URL or crew_config.FILES_URL)
...
def verify_tool_file_signature(file_id: str, timestamp: str, nonce: str, sign: str) -> bool:
    ...
    return current_time - int(timestamp) <= crew_config.FILES_ACCESS_TIMEOUT
