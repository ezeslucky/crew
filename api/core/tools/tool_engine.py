...
from core.callback_handler.agent_tool_callback_handler import CrewAgentCallbackHandler
...
class ToolEngine:
    ...
    def agent_invoke(
        ...
        agent_tool_callback: CrewAgentCallbackHandler,
    ...
    def generic_invoke(
        ...
        user_id: str,
        workflow_tool_callback: CrewWorkflowCallbackHandler,
