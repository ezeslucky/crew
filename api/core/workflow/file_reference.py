...
The canonical Crew file reference format is ``crew-file-ref:<base64url-json>``
...
_FILE_REFERENCE_PREFIX = "crew-file-ref:"
...
def build_file_reference(*, record_id: str, storage_key: str | None = None) -> str:
    """Build one canonical opaque ``crew-file-ref:...`` string.
...
def is_canonical_file_reference(reference: str | None) -> bool:
    ...
    Use this when new contracts require ``crew-file-ref:...`` and raw record ids
    must be rejected.
    """
