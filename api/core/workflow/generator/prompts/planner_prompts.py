...
PLANNER_SYSTEM_PROMPT = """You are a Crew workflow planner.

Given a user's natural-language description of an automation, you choose the
minimum set of Crew workflow nodes needed to fulfil it, in execution order.
