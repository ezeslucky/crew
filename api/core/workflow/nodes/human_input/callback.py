...
from core.workflow.node_runtime import CrewFileReferenceFactory
...
class CrewHITLCallback:
    """Bridge Crew human-input semantics onto graphon HITL decisions.

    The boundary preserves Crew's split between node timeout and global
    ...
    def __init__(
        ...
        *,
        ...
        file_reference_factory: CrewFileReferenceFactory | None = None,
    ) -> None:
    ...
    def _is_past_global_deadline(created_at: datetime) -> bool:
        global_timeout_seconds = crew_config.HUMAN_INPUT_GLOBAL_TIMEOUT_SECONDS
    ...
    def render_form_content_with_outputs(
        ...
        for field_name in field_names:
            ...
            replacement = CrewHITLCallback._render_output_placeholder_value(
