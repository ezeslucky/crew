...
def apply_runtime_defaults() -> None:
    ...
    os.environ.setdefault("STORAGE_LOCAL_PATH", "/tmp/crew-storage")
    os.environ.setdefault("SWAGGER_UI_ENABLED", "true")

    from configs import crew_config

    crew_config.SECRET_KEY = os.environ["SECRET_KEY"]
    crew_config.STORAGE_TYPE = "local"
    crew_config.STORAGE_LOCAL_PATH = os.environ["STORAGE_LOCAL_PATH"]
    crew_config.SWAGGER_UI_ENABLED = os.environ["SWAGGER_UI_ENABLED"].lower() == "true"
