...
def init_app(app: CrewApp) -> None:
    docs_enabled = crew_config.SWAGGER_UI_ENABLED
    ...
    router = FlaskRouter(
        ...
        title="Crew API (FastOpenAPI PoC)",
        version="1.0",
        description="FastOpenAPI proof of concept for Crew API",
    )
    ...
    CORS(
        app,
        resources={r"/console/api/.*": {"origins": crew_config.CONSOLE_CORS_ALLOW_ORIGINS}},
