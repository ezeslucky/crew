"""
Logstore extension for Crew application.
...
def is_enabled() -> bool:
    ...
    repository_configs = [
        crew_config.CORE_WORKFLOW_EXECUTION_REPOSITORY,
        crew_config.CORE_WORKFLOW_NODE_EXECUTION_REPOSITORY,
        crew_config.API_WORKFLOW_NODE_EXECUTION_REPOSITORY,
        crew_config.API_WORKFLOW_RUN_REPOSITORY,
    ]
...
def init_app(app: CrewApp):
    ...
    Args:
        app: The Crew application instance
    """
    try:
