...
from extensions.otel.semconv import CrewSpanAttributes, GenAIAttributes
        ...
        **kwargs: P.kwargs,
        ...
        try:
            ...
            attributes: dict[str, AttributeValue] = {
                CrewSpanAttributes.APP_ID: app_id,
                CrewSpanAttributes.TENANT_ID: tenant_id,
                GenAIAttributes.USER_ID: user_id,
                CrewSpanAttributes.USER_TYPE: "Account" if isinstance(user, Account) else "EndUser",
                CrewSpanAttributes.STREAMING: streaming,
                CrewSpanAttributes.WORKFLOW_ID: workflow_id,
            }
