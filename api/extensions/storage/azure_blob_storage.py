...
class AzureBlobStorage(BaseStorage):
    ...
    def __init__(self):
        super().__init__()
        self.bucket_name = crew_config.AZURE_BLOB_CONTAINER_NAME
        self.account_url = crew_config.AZURE_BLOB_ACCOUNT_URL
        self.account_name = crew_config.AZURE_BLOB_ACCOUNT_NAME
        self.account_key = crew_config.AZURE_BLOB_ACCOUNT_KEY
