...
class BaiduObsStorage(BaseStorage):
    ...
    def __init__(self):
        super().__init__()
        self.bucket_name = crew_config.BAIDU_OBS_BUCKET_NAME
        client_config = BceClientConfiguration(
            credentials=BceCredentials(
                access_key_id=crew_config.BAIDU_OBS_ACCESS_KEY,
                secret_access_key=crew_config.BAIDU_OBS_SECRET_KEY,
            ),
            endpoint=crew_config.BAIDU_OBS_ENDPOINT,
        )
