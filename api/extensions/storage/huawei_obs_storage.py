...
class HuaweiObsStorage(BaseStorage):
    ...
    def __init__(self):
        ...
        self.bucket_name = crew_config.HUAWEI_OBS_BUCKET_NAME
        self.client = ObsClient(
            access_key_id=crew_config.HUAWEI_OBS_ACCESS_KEY,
            secret_access_key=crew_config.HUAWEI_OBS_SECRET_KEY,
            server=crew_config.HUAWEI_OBS_SERVER,
            path_style=crew_config.HUAWEI_OBS_PATH_STYLE,
        )
