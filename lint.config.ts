...
const crewUiPackageJson = path.resolve(rootDir, 'packages/crew-ui/package.json')
  ...
  overrides: [
          ...
          'error',
          {
            ...
            patterns: [
              ...
              },
              {
                ...
                message:
                  'Do not import Base UI directly in web. Use @crew/crew-ui/* primitives instead.',
              },
              {
                group: ['@floating-ui/*'],
                message:
                  'Do not import Floating UI directly in web. Use @crew/crew-ui/* primitives instead.',
              },
              {
                group: ['**/base/input', '**/base/input/*'],
                message:
                  'Do not import the deprecated web base Input. Use @crew/crew-ui/input for standalone inputs, and @crew/crew-ui/field for labelled or validated form composition.',
              },
              {
                group: [
                  '@/service/base',
    ...
    },
    {
      files: [
        ...
        'packages/crew-ui/**/*.{js,cjs,mjs,jsx,ts,cts,mts,tsx}',
      ],
      rules: {
    ...
    {
      files: ['packages/crew-ui/**/*.{js,cjs,mjs,jsx,ts,cts,mts,tsx}'],
      rules: {
    ...
    {
      files: [
        'packages/crew-ui/**/*.stories.{js,cjs,mjs,jsx,ts,tsx}',
        'packages/crew-ui/**/*.story.{js,cjs,mjs,jsx,ts,tsx}',
      ],
      rules: {
        'storybook/await-interactions': 'error',
        'storybook/context-in-play-function': 'error',
    ...
    {
      files: ['packages/crew-ui/**/.storybook/main.{js,cjs,mjs,ts}'],
      rules: {
        'storybook/no-uninstalled-addons': [
          'error',
          {
            packageJsonLocation: crewUiPackageJson,
          },
        ],
      },
    },
    {
      files: [
        'packages/crew-ui/**/__tests__/**/*.{js,cjs,mjs,jsx,ts,cts,mts,tsx}',
        'packages/crew-ui/**/*.spec.{js,cjs,mjs,jsx,ts,cts,mts,tsx}',
      ],
      rules: {
