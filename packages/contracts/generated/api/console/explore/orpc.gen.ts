...
import {
  ...
  zGetExploreAppsLearnCrewQuery,
  zGetExploreAppsLearnCrewResponse,
...
export const get = oc
  .route({
    ...
    method: 'GET',
    operationId: 'getExploreAppsLearnCrew',
    path: '/explore/apps/learn-crew',
    tags: ['console'],
  })
  .input(z.object({ query: zGetExploreAppsLearnCrewQuery.optional() }))
  .output(zGetExploreAppsLearnCrewResponse)

export const learnCrew = {
  get,
}
