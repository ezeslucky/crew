...
/**
 * AgentComposerCrewToolCandidateResponse
 */
export const zAgentComposerCrewToolCandidateResponse = z.object({
  description: z.string().nullish(),
...
export const zAgentComposerSoulCandidatesResponse = z.object({
  ...
  crew_tools: z.array(zAgentComposerCrewToolCandidateResponse).optional(),
  human_contacts: z.array(zAgentHumanContactConfig).optional(),
...
/**
 * AgentSoulCrewToolCredentialRef
 *
 * Reference to a stored Crew Plugin Tool credential.
 *
 * Secret values are resolved only at runtime. The legacy ``credential_id``
 * field is accepted by :class:`AgentSoulCrewToolConfig` and normalized here so
 * old Agent tool payloads can be read while new payloads stay explicit.
 */
export const zAgentSoulCrewToolCredentialRef = z.object({
  id: z.string().max(255).nullish(),
  provider: z.string().max(255).nullish(),
...
export const zAgentSoulCrewToolConfig = z.object({
  credential_ref: zAgentSoulCrewToolCredentialRef.nullish(),
...
export const zAgentSoulToolsConfig = z.object({
  cli_tools: z.array(zAgentCliToolConfig).optional(),
  crew_tools: z.array(zAgentSoulCrewToolConfig).optional(),
})
