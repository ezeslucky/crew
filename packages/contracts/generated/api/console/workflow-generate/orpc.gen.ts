...
/**
 * Stream a Crew workflow graph (plan then result) via SSE
 */
export const post = oc
  .route({
    description: 'Stream a Crew workflow graph (plan then result) via SSE',
...
/**
 * Generate a Crew workflow graph from natural language
 */
export const post3 = oc
  .route({
    description: 'Generate a Crew workflow graph from natural language',
    inputStructure: 'detailed',
    method: 'POST',
