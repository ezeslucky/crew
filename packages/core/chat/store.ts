...
const AGENT_STORAGE_KEY = "crew:chat:selectedAgentId";
const SESSION_STORAGE_KEY = "crew:chat:activeSessionId";
/** Drafts are stored as one JSON blob per workspace: { [sessionId]: text }. */
const DRAFTS_KEY = "crew:chat:drafts";
/** Draft attachment records per workspace: { [sessionId]: Attachment[] }. */
const DRAFT_ATTACHMENTS_KEY = "crew:chat:draft-attachments";
/**
 ...
 */
const APPLIED_RESTORES_KEY = "crew:chat:applied-draft-restores";
/**
 ...
 */
const PENDING_SEND_RESTORES_KEY = "crew:chat:pending-send-restores";
/**
...
const CHAT_WIDTH_KEY = "crew:chat:width";
const CHAT_HEIGHT_KEY = "crew:chat:height";
const CHAT_EXPANDED_KEY = "crew:chat:expanded";
/**
 ...
 */
const OPEN_KEY = "crew:chat:isOpen";
/**
 ...
 */
const FLOATING_KEY = "crew:chat:floatingChatEnabled";
