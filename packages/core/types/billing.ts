// Mirrors the crew-cloud Billing module response shapes
// (crew-cloud/docs/api/billing.md). These types are the contract our
// frontend consumes via /api/cloud-billing/* — crew-api itself does
