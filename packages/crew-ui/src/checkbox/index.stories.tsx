...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Checkbox primitive built on Base UI. It preserves Base UI checked, indeterminate, disabled, and hidden input semantics while applying the Crew 16px checkbox design from Figma. Import from `@crew/crew-ui/checkbox`.',
      },
    },
  },
  tags: ['autodocs'],
...
export const StateMatrix: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'The full visual matrix for Crew checkbox states. State styling comes from Base UI data attributes such as data-checked, data-indeterminate, and data-disabled.',
      },
    },
  },
}
