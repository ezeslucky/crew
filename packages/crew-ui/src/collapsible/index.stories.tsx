...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Styled Crew disclosure wrapper over Base UI Collapsible. It preserves the official Root, Trigger, and Panel anatomy while providing Crew layout, focus, disabled, and motion styles.',
      },
    },
  },
  tags: ['autodocs'],
