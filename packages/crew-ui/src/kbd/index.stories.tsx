...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Keyboard input primitives aligned with the Crew Key Set design. ' +
...
export const InContextMenu: Story = {
  parameters: {
    docs: {
      description: {
        story:
          'A compact context-menu composition based on the Crew Design Kit context menu example. The menu is intentionally small here because the story focuses on shortcut keycaps.',
      },
    },
  },
  render: () => (
