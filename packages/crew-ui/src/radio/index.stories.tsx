...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          '`@crew/crew-ui/radio` exports the complete radio family. `RadioGroup` owns single-selection state, `Radio` is the default Crew control for plain form rows, `RadioItem` makes custom UI the radio item, and `RadioControl` renders the standard visual dot inside custom items.',
      },
    },
  },
  tags: ['autodocs'],
...
export const OptionCards: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Custom option UIs should make the whole interactive surface the radio item with `RadioItem`. `RadioControl` is the Crew visual dot; the radio semantics stay on `RadioItem`.',
      },
    },
  },
}
  ...
  return (
    <Field name="generation_mode" className="flex w-80 flex-col gap-2">
      <FieldDescription className="body-xs-regular text-text-tertiary">
        This mirrors Crew dynamic form fields where radio options are controlled by schema and
...
export const DynamicFormField: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Matches Crew form composition: Field and Fieldset provide group labeling while `RadioGroup` owns controlled single-selection state.',
      },
    },
  },
}
...
export const StateMatrix: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'The visual matrix for Crew radio states. State styling comes from Base UI data attributes such as data-checked and data-disabled.',
      },
    },
  },
}
