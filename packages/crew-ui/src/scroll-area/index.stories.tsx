...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Compound scroll container built on Base UI Scroll Area. The examples mirror the upstream anatomy and focus patterns while applying Crew UI tokens and surface treatments. Base UI ScrollArea.Content defaults to min-width: fit-content, so vertical-only regions that should truncate long content must set min-width: 0 on the content slot.',
      },
    },
  },
  tags: ['autodocs'],
