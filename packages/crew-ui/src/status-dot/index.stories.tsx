...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Status Dot primitive from the Crew Design Kit. Use it for compact visual status indicators; provide an accessible label only when the dot is the sole status representation.',
      },
    },
  },
  tags: ['autodocs'],
