...
describe('dev proxy server', () => {
  ...
  // Scenario: generic proxy routes should not know Crew cookie names by default.
  ...
  // Scenario: scoped Crew auth cookies should prevent stale local cookies from leaking across targets.
