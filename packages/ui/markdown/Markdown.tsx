...
export interface MarkdownProps {
  ...
  /**
   * CDN hostname for file card detection (e.g. "crew-static.copilothub.ai").
...
// and crew's internal mention/slash protocols.
...
/**
 * Custom URL transform that allows crew internal protocols while keeping
