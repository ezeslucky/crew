...
import { useFeatureEnabled } from "@crew/core/config";
import { AGENT_BUILDER_FLAG } from "@crew/core/feature-flags";
import {
  agentTemplateDetailOptions,
  agentTemplateListOptions,
} from "@crew/core/agents";
import {
  chatKeys,
  chatMessagesOptions,
...
const BUILDER_INPUT_PREFIX = "CREW_AGENT_BUILDER_INPUT\n";
