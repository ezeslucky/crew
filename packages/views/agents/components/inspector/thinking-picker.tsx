...
import type { RuntimeModelThinkingLevel } from "@crew/core/types";
 ...
 * the user's local CLI install, not by Crew's catalog.
 */
      ...
      {levels.map((l) => (
        ...
        >
          ...
          {/* No model-factory-default badge here on purpose: when the
              picker is "Follow CLI config" (value === ""), Crew omits
