...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@crew/ui/components/ui/collapsible";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
...
import { isTaskMessageTaskId, taskMessagesOptions } from "@crew/core/chat/queries";
import { MemoizedMarkdown } from "@crew/views/common/markdown";
import { copyText } from "@crew/ui/lib/clipboard";
import { AttachmentList } from "../../issues/components/comment-card";
import type { AgentAvailability } from "@crew/core/agents";
import type {
  ChatMessage,
  ChatPendingTask,
  TaskFailureReason,
...
import type { ChatTimelineItem } from "@crew/core/chat";
...
function TimelineView({
  ...
  isStreaming?: boolean;
  attachments?: import("@crew/core/types").Attachment[];
}) {
