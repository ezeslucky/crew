...
import type { Agent, ChatSession } from "@crew/core/types";
...
vi.mock("@crew/core/hooks", () => ({ useWorkspaceId: () => "ws-1" }));
...
vi.mock("@crew/views/issues/components", () => ({ canAssignAgent: () => true }));
...
vi.mock("@crew/core/chat/mutations", () => ({
