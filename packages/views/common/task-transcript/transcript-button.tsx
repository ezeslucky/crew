...
import type { TaskMessagePayload } from "@crew/core/types/events";
...
export function TranscriptButton({
  ...
  useEffect(() => {
    ...
    window.addEventListener("crew:navigate", handleGlobalNavigate);
    return () => {
      window.removeEventListener("crew:navigate", handleGlobalNavigate);
    };
  }, [open]);
