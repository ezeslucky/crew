...
import { isGlobalPath } from "@crew/core/paths";
...
/**
 * Open a link — internal paths dispatch crew:navigate, external open new tab.
 *
...
export function openLink(href: string, currentSlug?: string | null): void {
  if (href.startsWith("/")) {
    ...
    window.dispatchEvent(
      new CustomEvent("crew:navigate", { detail: { path } }),
    );
  } else {
