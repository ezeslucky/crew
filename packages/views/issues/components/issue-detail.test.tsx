...
import type { Issue, TimelineEntry } from "@crew/core/types";
import { I18nProvider } from "@crew/core/i18n/react";
import { useResolvedExpandStore } from "@crew/core/issues/stores/resolved-expand-store";
...
vi.mock("@crew/ui/hooks/use-mobile", () => ({
  useIsMobile: () => mockViewport.isMobile,
}));

// useWorkspaceId() derives from useCurrentWorkspace (relative import inside
// @crew/core/hooks.tsx). vi.mock("@crew/core/paths") only intercepts
...
// Mock @crew/core/workspace/hooks
...
// Mock @crew/core/paths — after the URL-driven workspace refactor,
...
vi.mock("../../navigation", () => ({
  ...
  useNavigation: () => ({
    ...
    getShareableUrl: (p: string) => `https://app.crew.com${p}`,
  }),
...
// Mock issue config
vi.mock("@crew/core/issues/config", () => ({
...
vi.mock("@crew/core/issues/stores", async () => ({
  ...
  ...(await vi.importActual<
    typeof import("@crew/core/issues/stores/resolved-expand-store")
  >("@crew/core/issues/stores/resolved-expand-store")),
...
// Mock react-resizable-panels (used by @crew/ui/components/ui/resizable)
