...
import { Skeleton } from "@crew/ui/components/ui/skeleton";
import { Button } from "@crew/ui/components/ui/button";
import { ResizablePanelGroup, ResizablePanel, ResizableHandle } from "@crew/ui/components/ui/resizable";
import { Sheet, SheetContent } from "@crew/ui/components/ui/sheet";
import { useIsMobile } from "@crew/ui/hooks/use-mobile";
...
import { FileUploadButton } from "@crew/ui/components/common/file-upload-button";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
} from "@crew/ui/components/ui/tooltip";
import { Popover, PopoverTrigger, PopoverContent } from "@crew/ui/components/ui/popover";
import { Dialog, DialogContent, DialogHeader, DialogTitle } from "@crew/ui/components/ui/dialog";
import { Checkbox } from "@crew/ui/components/ui/checkbox";
import { Command, CommandInput, CommandList, CommandEmpty, CommandGroup, CommandItem } from "@crew/ui/components/ui/command";
import { AvatarGroup, AvatarGroupCount } from "@crew/ui/components/ui/avatar";
import { ActorAvatar } from "../../common/actor-avatar";
import { PropRow } from "../../common/prop-row";
import { PropertyIcon } from "../../common/property-icon";
import type { Attachment, Issue, IssueStatus, IssuePriority, TimelineEntry, UpdateIssueRequest } from "@crew/core/types";
import { contentReferencesAttachment } from "@crew/core/types";
import { STATUS_CONFIG, PRIORITY_CONFIG } from "@crew/core/issues/config";
import { formatDateOnly } from "@crew/core/issues/date";
import { useUpdateIssue } from "@crew/core/issues/mutations";
...
import { useGitHubSettings } from "@crew/core/github";
import { useQuery } from "@tanstack/react-query";
import { useAuthStore } from "@crew/core/auth";
import { useWorkspacePaths } from "@crew/core/paths";
import { useActorName } from "@crew/core/workspace/hooks";
import { useWorkspaceId } from "@crew/core/hooks";
import { useRecentContextStore } from "@crew/core/chat";
import { issueListOptions, issueDetailOptions, childIssuesOptions, issueUsageOptions, issueAttachmentsOptions } from "@crew/core/issues/queries";
import { projectDetailOptions } from "@crew/core/projects/queries";
import { ProjectIcon } from "../../projects/components/project-icon";
import { issueLabelsOptions } from "@crew/core/labels";
import { propertyListOptions } from "@crew/core/properties";
import { memberListOptions, agentListOptions } from "@crew/core/workspace/queries";
import {
  selectExpandedResolved,
  useCommentComposerStore,
  useRecentIssuesStore,
  useResolvedExpandStore,
} from "@crew/core/issues/stores";
import { useIssueSelectionStore } from "@crew/core/issues/stores/selection-store";
import { BatchActionToolbar } from "./batch-action-toolbar";
import { useIssueTimeline } from "../hooks/use-issue-timeline";
import { useIssueReactions } from "../hooks/use-issue-reactions";
import { useIssueSubscribers } from "../hooks/use-issue-subscribers";
import { ReactionBar } from "@crew/ui/components/common/reaction-bar";
import { useTimeAgo } from "../../i18n";
import { useRestoredScrollOffset, useRestoredScrollRef } from "../../platform";
import { cn } from "@crew/ui/lib/utils";
...
export function IssueDetail({ issueId, onDelete, onDone, defaultSidebarOpen = true, layoutId = "crew_issue_detail_layout", highlightCommentId }: IssueDetailProps) {
  const { t } = useT("issues");
