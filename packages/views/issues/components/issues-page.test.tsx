...
// Mock @crew/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@crew/core/issues/stores/view-store", () => ({
...
vi.mock("@crew/core/issues/stores/view-store-context", () => ({
...
vi.mock("@crew/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@crew/core/issues/stores/selection-store", () => ({
...
vi.mock("@crew/core/issues/stores/recent-issues-store", () => ({
