...
import type { GitHubPullRequest } from "@crew/core/types";
import enCommon from "../../locales/en/common.json";
import enIssues from "../../locales/en/issues.json";

const TEST_RESOURCES = { en: { common: enCommon, issues: enIssues } };

vi.mock("@crew/core/github/queries", async () => {
  const actual = await vi.importActual<typeof import("@crew/core/github/queries")>(
    "@crew/core/github/queries",
  );
  return {
    ...actual,
