...
import { useScrollFade } from "@crew/ui/hooks/use-scroll-fade";
...
import { ActorAvatar } from "@crew/ui/components/common/actor-avatar";
import { Tooltip, TooltipTrigger, TooltipContent } from "@crew/ui/components/ui/tooltip";
import { Collapsible, CollapsibleTrigger, CollapsibleContent } from "@crew/ui/components/ui/collapsible";
import { CappedNumberFlow } from "@crew/ui/components/ui/number-flow";
import { StatusIcon } from "../issues/components/status-icon";
import { useIssueDraftStore } from "@crew/core/issues/stores/draft-store";
import { openCreateIssueWithPreference } from "@crew/core/issues/stores/create-mode-store";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
  ...
  SidebarMenuItem,
  SidebarRail,
} from "@crew/ui/components/ui/sidebar";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuGroup,
  ...
  DropdownMenuTrigger,
} from "@crew/ui/components/ui/dropdown-menu";
import { useAuthStore } from "@crew/core/auth";
import { useCurrentWorkspace, useWorkspacePaths, paths } from "@crew/core/paths";
import { workspaceListOptions, myInvitationListOptions, workspaceKeys } from "@crew/core/workspace/queries";
import { resolvePublicFileUrl } from "@crew/core/workspace/avatar-url";
import { useQuery, useMutation, useQueryClient } from "@tanstack/react-query";
import { inboxKeys, deduplicateInboxItems, inboxUnreadSummaryOptions, hasOtherWorkspaceUnread, unreadWorkspaceIds } from "@crew/core/inbox/queries";
import { chatSessionsOptions } from "@crew/core/chat/queries";
import { countUnreadChatMessages } from "@crew/core/chat/unread";
import { useChatStore } from "@crew/core/chat";
import { api, ApiError } from "@crew/core/api";
import { useModalStore } from "@crew/core/modals";
import { useConfigStore } from "@crew/core/config";
import { pinListOptions } from "@crew/core/pins/queries";
import { useDeletePin, useReorderPins } from "@crew/core/pins/mutations";
import { issueDetailOptions } from "@crew/core/issues/queries";
import { projectDetailOptions } from "@crew/core/projects/queries";
import type { PinnedItem } from "@crew/core/types";
import { useLogout } from "../auth";
import { ProjectIcon } from "../projects/components/project-icon";
import { useT } from "../i18n";
import {
  useShortcut,
} from "@crew/core/shortcuts";
