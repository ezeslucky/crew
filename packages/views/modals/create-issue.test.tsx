...
vi.mock("@crew/core/hooks", () => ({
  useWorkspaceId: () => "ws-test",
}));

vi.mock("@crew/core/issues/queries", () => ({
...
vi.mock("@crew/core/workspace/hooks", () => ({
...
vi.mock("@crew/core/issues/stores/draft-store", () => ({
...
vi.mock("@crew/core/issues/stores/quick-create-store", () => ({
  useQuickCreateStore: (selector?: (state: typeof mockQuickCreateStore) => unknown) =>
    (selector ? selector(mockQuickCreateStore) : mockQuickCreateStore),
}));

vi.mock("@crew/core/issues/mutations", () => ({
  useCreateIssue: () => ({ mutateAsync: mockCreateIssue }),
  useUpdateIssue: () => ({ mutate: vi.fn() }),
}));

vi.mock("@crew/core/labels", () => ({
  useAttachLabelToIssue: () => ({ mutateAsync: mockAttachLabel }),
}));

vi.mock("@crew/core/hooks/use-file-upload", () => ({
...
vi.mock("@crew/core/api", async () => {
  ...
  const { parseWithFallback } = await vi.importActual<typeof import("@crew/core/api/schema")>(
    "@crew/core/api/schema",
  );
  const { DuplicateIssueErrorBodySchema } = await vi.importActual<
    typeof import("@crew/core/api/schemas")
  >("@crew/core/api/schemas");
  return {
    api: {},
    ApiError,
    parseWithFallback,
...
vi.mock("@crew/ui/components/ui/dialog", () => ({
...
vi.mock("@crew/ui/components/ui/dropdown-menu", () => ({
...
vi.mock("@crew/ui/components/ui/tooltip", () => ({
...
vi.mock("@crew/ui/components/ui/button", () => ({
  Button: ({
    children,
    disabled,
    onClick,
...
vi.mock("@crew/ui/components/ui/switch", () => ({
  Switch: ({
    checked,
    onCheckedChange,
  }: {
...
vi.mock("@crew/ui/components/common/file-upload-button", () => ({
...
describe("CreateIssueModal", () => {
  beforeEach(() => {
    ...
    mockUploadWithToast.mockResolvedValue({
      ...
      markdown_url: "https://Crew-api.copilothub.ai/api/attachments/11111111-2222-3333-4444-555555555555/download",
      content_type: "image/png",
      size_bytes: 123,
      created_at: "2026-06-12T00:00:00Z",
      link: "https://cdn.example.test/shot.png",
      markdownLink: "https://Crew-api.copilothub.ai/api/attachments/11111111-2222-3333-4444-555555555555/download",
    });
  ...
  it("prunes draft attachments the reopened description no longer references", async () => {
    ...
    const deleted = {
      ...
      markdown_url: "https://Crew-api.copilothub.ai/api/attachments/99999999-8888-7777-6666-555555555555/download",
    };
    mockDraftStore.draft.title = "Image draft";
