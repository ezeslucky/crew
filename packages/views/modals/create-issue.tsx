...
import type { Issue, IssueStatus, IssuePriority, IssueAssigneeType, Attachment } from "@crew/core/types";
import { contentReferencesAttachment } from "@crew/core/types";
import {
  DialogContent,
  DialogTitle,
} from "@crew/ui/components/ui/dialog";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
import { Tooltip, TooltipTrigger, TooltipContent, TooltipProvider } from "@crew/ui/components/ui/tooltip";
import { Button } from "@crew/ui/components/ui/button";
import { Switch } from "@crew/ui/components/ui/switch";
...
import { useCurrentWorkspace, useWorkspacePaths } from "@crew/core/paths";
import { useWorkspaceId } from "@crew/core/hooks";
import { useIssueDraftStore } from "@crew/core/issues/stores/draft-store";
import { useCreateModeStore } from "@crew/core/issues/stores/create-mode-store";
import { useQuickCreateStore } from "@crew/core/issues/stores/quick-create-store";
import { issueDetailOptions, childIssuesOptions } from "@crew/core/issues/queries";
import { useCreateIssue, useUpdateIssue } from "@crew/core/issues/mutations";
import { useAttachLabelToIssue } from "@crew/core/labels";
import {
  ApiError,
...
import { Dialog as DialogRoot } from "@crew/ui/components/ui/dialog";
