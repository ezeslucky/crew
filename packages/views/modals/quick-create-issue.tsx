...
import { DialogTitle } from "@crew/ui/components/ui/dialog";
...
import { useCurrentWorkspace } from "@crew/core/paths";
import { agentListOptions, squadListOptions } from "@crew/core/workspace/queries";
import { projectListOptions } from "@crew/core/projects/queries";
import {
  useQuickCreateStore,
  type QuickCreateActorType,
} from "@crew/core/issues/stores/quick-create-store";
...
} from "@crew/core/runtimes";
import { useShortcut } from "@crew/core/shortcuts";
import { ShortcutKeycaps } from "../common/shortcut-keycaps";
import { contentReferencesAttachment, type Agent, type Attachment, type Squad } from "@crew/core/types";
...
import { memberListOptions } from "@crew/core/workspace/queries";
import {
  ContentEditor,
...
export function AgentCreatePanel({
  ...
  // bundled Crew CLI to be ≥ MIN_QUICK_CREATE_CLI_VERSION; older
