...
import { CrewIcon } from "@crew/ui/components/common/crew-icon";
import { cn } from "@crew/ui/lib/utils";
import { DragStrip } from "@crew/views/platform";
import { STATUS_CONFIG } from "@crew/core/issues/config";
        ...
        <div className="flex flex-1 flex-col justify-center px-6 pb-12 sm:px-10 md:px-20 lg:px-20 xl:px-24">
          <div className="flex w-full max-w-[540px] flex-col gap-8">
            <div className="flex items-center gap-2.5">
              <CrewIcon className="size-5 text-foreground" noSpin />
