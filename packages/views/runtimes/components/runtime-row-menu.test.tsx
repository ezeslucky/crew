...
import type { AgentRuntime, RuntimeProfile } from "@crew/core/types";
...
vi.mock("@crew/core/runtimes/mutations", () => ({
...
describe("runtime list CLI column", () => {
  ...
  // shared crew daemon `cli_version`. It must instead show the agent's own
