...
import { memberListOptions, workspaceKeys } from "@crew/core/workspace/queries";
import {
  deriveGitHubSettings,
  githubInstallationsOptions,
} from "@crew/core/github";
import { api } from "@crew/core/api";
import type { Workspace } from "@crew/core/types";
              ...
              description={
                <p className="text-sm text-muted-foreground">
                  ...
                  <code className="rounded bg-muted px-1 py-0.5 text-xs">
                    {"Co-authored-by: crew-agent <github@crew.ai>"}
                  </code>{" "}
