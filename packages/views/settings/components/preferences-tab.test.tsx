...
vi.mock("@crew/core/i18n/react", async () => {
  const actual =
    await vi.importActual<typeof import("@crew/core/i18n/react")>(
      "@crew/core/i18n/react",
    );
  return {
    ...actual,
    useLocaleAdapter: () => ({
...
import { useCommentComposerStore } from "@crew/core/issues/stores";
