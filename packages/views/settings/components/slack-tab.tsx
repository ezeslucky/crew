...
import { slackInstallationsOptions, slackKeys } from "@crew/core/slack";
import { api } from "@crew/core/api";
import type { SlackInstallation } from "@crew/core/types";
  ...
  const prefix = lang?.startsWith("zh")
    ...
    : lang?.startsWith("ja")
      ...
      : lang?.startsWith("ko")
        ? "/ko"
        : "";
  return `https://crew.ai/docs${prefix}/slack-bot-integration`;
}
