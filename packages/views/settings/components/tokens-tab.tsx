...
import type { PersonalAccessToken } from "@crew/core/types";
import { Alert, AlertDescription } from "@crew/ui/components/ui/alert";
...
export function TokensTab() {
  ...
  const handleCopyCommand = async () => {
    if (!newToken) return;
    if (await copyText(`crew login --token ${newToken}`)) {
