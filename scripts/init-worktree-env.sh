...
postgres_db="crew_${slug}_${offset}"
postgres_port=5432
...
DATABASE_URL=postgres://crew:crew@localhost:${postgres_port}/${postgres_db}?sslmode=disable

PORT=${backend_port}
JWT_SECRET=change-me-in-production
CREW_DEV_VERIFICATION_CODE=888888
CREW_SERVER_URL=ws://localhost:${backend_port}/ws
CREW_APP_URL=${frontend_origin}
