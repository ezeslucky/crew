...
const DB = process.env.DATABASE_URL || "postgres://crew:crew@localhost:5432/crew_crew_101?sslmode=disable";
...
async function main() {
  ...
  await page.evaluate((t) => localStorage.setItem("crew_token", t), token);
