...
export class ChatClient extends CrewClient {
  createChatMessage(
    request: ChatMessageRequest,
  ): Promise<CrewResponse<ChatMessageResponse> | CrewStream<ChatMessageResponse>>
  createChatMessage(
    inputs: JsonObject,
    query: string,
    user: string,
  ...
  stopChatMessage(taskId: string, user: string): Promise<CrewResponse<SuccessResponse>> {
  ...
  stopMessage(taskId: string, user: string): Promise<CrewResponse<SuccessResponse>> {
    return this.stopChatMessage(taskId, user)
  }

  getSuggested(messageId: string, user: string): Promise<CrewResponse<SuggestedQuestionsResponse>> {
  ...
  // Note: messageFeedback is inherited from CrewClient

  getAppFeedbacks(page?: number, limit?: number): Promise<CrewResponse<JsonObject>> {
  ...
  ): Promise<CrewResponse<JsonObject>> {
    ensureNonEmptyString(user, 'user')
  ...
  deleteConversation(conversationId: string, user: string): Promise<CrewResponse<SuccessResponse>> {
    ensureNonEmptyString(conversationId, 'conversationId')
    ensureNonEmptyString(user, 'user')
    return this.http.request({
      method: 'DELETE',
  ...
  ): Promise<CrewResponse<AnnotationResponse>> {
  ...
  listAnnotations(options?: AnnotationListOptions): Promise<CrewResponse<AnnotationResponse>> {
  ...
  createAnnotation(request: AnnotationCreateRequest): Promise<CrewResponse<AnnotationResponse>> {
  ...
  deleteAnnotation(annotationId: string): Promise<CrewResponse<AnnotationResponse>> {
    ensureNonEmptyString(annotationId, 'annotationId')
    return this.http.request({
      method: 'DELETE',
      path: `/apps/annotations/${annotationId}`,
  ...
  // Note: audioToText is inherited from CrewClient
}
