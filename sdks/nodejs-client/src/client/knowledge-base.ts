...
import type { CrewResponse, CrewStream, QueryParams } from '../types/common'
import type {
...
import { FileUploadError, ValidationError } from '../errors/crew-error'
...
export class KnowledgeBaseClient extends CrewClient {
  async listDatasets(options?: DatasetListOptions): Promise<CrewResponse<KnowledgeBaseResponse>> {
  ...
  async createDataset(request: DatasetCreateRequest): Promise<CrewResponse<KnowledgeBaseResponse>> {
  ...
  async getDataset(datasetId: string): Promise<CrewResponse<KnowledgeBaseResponse>> {
  ...
  ): Promise<CrewResponse<KnowledgeBaseResponse>> {
    ensureNonEmptyString(datasetId, 'datasetId')
  ...
  async deleteDataset(datasetId: string): Promise<CrewResponse<KnowledgeBaseResponse>> {
    ensureNonEmptyString(datasetId, 'datasetId')
    return this.http.request({
      method: 'DELETE',
      path: `/datasets/${datasetId}`,
  ...
  async listTags(): Promise<CrewResponse<KnowledgeBaseResponse>> {
    return this.http.request({
      method: 'GET',
      path: '/datasets/tags',
    })
  ...
  async createTag(request: DatasetTagCreateRequest): Promise<CrewResponse<KnowledgeBaseResponse>> {
    ensureNonEmptyString(request.name, 'name')
    return this.http.request({
      method: 'POST',
      path: '/datasets/tags',
  ...
  async updateTag(request: DatasetTagUpdateRequest): Promise<CrewResponse<KnowledgeBaseResponse>> {
  ...
  async deleteTag(request: DatasetTagDeleteRequest): Promise<CrewResponse<KnowledgeBaseResponse>> {
    ensureNonEmptyString(request.tag_id, 'tag_id')
    return this.http.request({
      method: 'DELETE',
      path: '/datasets/tags',
  ...
  async bindTags(request: DatasetTagBindingRequest): Promise<CrewResponse<KnowledgeBaseResponse>> {
  ...
  async getDatasetTags(datasetId: string): Promise<CrewResponse<KnowledgeBaseResponse>> {
    ensureNonEmptyString(datasetId, 'datasetId')
    return this.http.request({
      method: 'GET',
  ...
  async listMetadata(datasetId: string): Promise<CrewResponse<KnowledgeBaseResponse>> {
    ensureNonEmptyString(datasetId, 'datasetId')
    return this.http.request({
      method: 'GET',
  ...
  async listBuiltInMetadata(datasetId: string): Promise<CrewResponse<KnowledgeBaseResponse>> {
    ensureNonEmptyString(datasetId, 'datasetId')
    return this.http.request({
      method: 'GET',
  ...
  ): Promise<CrewStream<PipelineStreamEvent>> {
    ensureNonEmptyString(datasetId, 'datasetId')
  ...
  ): Promise<CrewResponse<KnowledgeBaseResponse> | CrewStream<PipelineStreamEvent>> {
    ensureNonEmptyString(datasetId, 'datasetId')
    ensureNonEmptyString(request.datasource_type, 'datasource_type')
  ...
  async uploadPipelineFile(form: unknown): Promise<CrewResponse<KnowledgeBaseResponse>> {
