...
export class WorkflowClient extends CrewClient {
  run(
    request: WorkflowRunRequest,
  ): Promise<CrewResponse<WorkflowRunResponse> | CrewStream<WorkflowRunResponse>>
  run(
    inputs: JsonObject,
    user: string,
    stream?: boolean,
  ...
  getRun(workflowRunId: string): Promise<CrewResponse<WorkflowRunResponse>> {
