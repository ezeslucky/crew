...
class CrewClient {
    ...
    public function __construct($api_key, $base_url = null) {
        ...
        $this->base_url = $base_url ?? 'https://api.crew.ai/v1/';
...
class CompletionClient extends CrewClient {
...
class ChatClient extends CrewClient {
...
class WorkflowClient extends CrewClient{
