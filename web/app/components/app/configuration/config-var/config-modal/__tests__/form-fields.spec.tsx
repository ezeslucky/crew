...
vi.mock('@crew/crew-ui/select', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@crew/crew-ui/select')>()
...
describe('ConfigModalFormFields', () => {
  ...
  it('should wire file, json schema, and visibility controls', async () => {
    ...
    expect(docLink).toHaveAttribute(
      'href',
      'https://docs.example.com/use-crew/nodes/user-input#hide-and-pre-fill-input-fields',
    )
