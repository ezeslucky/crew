  ...
  const MockList = ({
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        {
          type: 'button',
          onClick: () => onTryLearnCrew?.({ appId: mockTemplateApp.app_id, app: mockTemplateApp }),
        },
        'Preview Learn Crew template',
      ),
      React.createElement(
        'button',
        { type: 'button', onClick: () => onCreateLearnCrew?.(mockTemplateApp) },
...
describe('Apps', () => {
  ...
  describe('Integration', () => {
    ...
    it('should open the template preview from Learn Crew', async () => {
    ...
    it('should open the create modal from Learn Crew', async () => {
      const user = userEvent.setup()
      renderWithClient(<Apps />)
