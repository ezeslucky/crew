...
const Apps = () => {
  ...
  const handleTryLearnCrew = (params: TryAppSelection) => {
    setShowTryAppPanel(true, params)
  }
  const handleCreateLearnCrew = (app: App) => {
    ...
    >
      <div className="relative flex h-0 shrink-0 grow flex-col overflow-y-auto bg-background-body">
        <List
          ...
          onCreateLearnCrew={handleCreateLearnCrew}
          onTryLearnCrew={handleTryLearnCrew}
        />
        {isShowTryAppPanel && (
          <TryApp
