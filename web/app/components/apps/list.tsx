...
import type { GetAppsData } from '@crew/contracts/api/console/apps/types.gen'
...
function List({ controlRefreshList = 0, onCreateLearnCrew, onTryLearnCrew }: Props) {
    ...
    <>
      ...
      >
        ...
        {showFirstEmptyState ? (
          <FirstEmptyState
            onCreateBlank={openCreateBlankModal}
            onCreateLearnCrew={onCreateLearnCrew}
            onCreateTemplate={openCreateTemplateDialog}
            onImportDSL={openCreateFromDSLModal}
            onTryLearnCrew={onTryLearnCrew}
            showLearnCrew={systemFeatures.enable_learn_app}
          />
        ) : (
          <>
