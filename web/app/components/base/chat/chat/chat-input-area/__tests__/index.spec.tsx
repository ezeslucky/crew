  ...
  describe('Feature Bar', () => {
    it('should render footer notice with an accessible infotip', async () => {
      ...
      const footerNoticeTooltip =
        'For Crew Community Edition, each of your agents runs in a Linux 7.0.0-10060-aws sandbox environment within your docker. Your edits to the environment via Build Chats are persistent.'
