...
describe('EmbeddedChatbot Header', () => {
  ...
  describe('Desktop Rendering', () => {
    ...
    it('should render Crew logo by default when branding enabled is true but no logo provided', () => {
      mockBranding = { enabled: true, workspace_logo: '' }
      render(<Header title="Test Chatbot" />)
      expect(screen.getByAltText('Crew')).toBeInTheDocument()
    })

    it('should render Crew logo when branding is disabled', () => {
  ...
  describe('Mobile Rendering', () => {
    ...
    it('should handle mobile expand button', async () => {
      ...
      expect(mockPostMessage).toHaveBeenCalledWith(
        { type: 'crew-chatbot-expand-change' },
        'https://parent.com',
      )
    })
  })
  ...
  describe('Iframe Communication', () => {
    it('should send crew-chatbot-iframe-ready on mount', () => {
      const mockPostMessage = setupIframe()
      render(<Header title="Iframe" />)

      expect(mockPostMessage).toHaveBeenCalledWith({ type: 'crew-chatbot-iframe-ready' }, '*')
    })
    ...
    it('should NOT handle toggle expand if showToggleExpandButton is false', async () => {
      ...
      expect(mockPostMessage).not.toHaveBeenCalledWith(
        expect.objectContaining({ type: 'crew-chatbot-expand-change' }),
        expect.anything(),
      )
    })
  })
