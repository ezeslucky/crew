...
const QRDemo = ({ content = 'https://crew.ai' }: { content?: string }) => {
  return (
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Toggleable QR code generator for sharing app URLs. Clicking the trigger reveals the code with a download CTA.',
      },
    },
  },
  argTypes: {
