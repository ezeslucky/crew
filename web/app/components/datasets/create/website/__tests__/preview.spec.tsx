...
describe('WebsitePreview', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render the payload source_url', () => {
      const payload = createPayload({ source_url: 'https://docs.crew.ai/intro' })

      render(<WebsitePreview payload={payload} hidePreview={mockHidePreview} />)

      const urlElement = screen.getByText('https://docs.crew.ai/intro')
      expect(urlElement).toBeInTheDocument()
      expect(urlElement).toHaveAttribute('title', 'https://docs.crew.ai/intro')
    })
