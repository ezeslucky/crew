...
vi.mock('@/context/i18n', () => ({
  useDocLink: () => (path?: string) =>
    path ? `https://docs.crew.ai/en${path}` : 'https://docs.crew.ai/en/',
}))
...
describe('WaterCrawl', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render URL input field', () => {
      ...
      // Assert - URL input has specific placeholder
      expect(screen.getByPlaceholderText('https://docs.crew.ai/en/'))!.toBeInTheDocument()
    })
  ...
  describe('Props', () => {
    ...
    it('should execute crawl task when checkedCrawlResult is provided', async () => {
      ...
      render(<WaterCrawl {...props} />)
      const input = screen.getByPlaceholderText('https://docs.crew.ai/en/')
  ...
  describe('State Management', () => {
    it('should transition from init to running state when run is clicked', async () => {
      ...
      render(<WaterCrawl {...props} />)
      const urlInput = screen.getByPlaceholderText('https://docs.crew.ai/en/')
