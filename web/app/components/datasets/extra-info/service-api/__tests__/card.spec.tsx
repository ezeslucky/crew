...
vi.mock('@crew/crew-ui/popover', () => ({
  PopoverClose: ({ render }: { render: React.ReactNode }) => render,
}))

vi.mock('@/hooks/use-api-access-url', () => ({
  useDatasetApiAccessUrl: () => 'https://docs.crew.ai/api-reference/datasets',
}))
...
describe('Service API card', () => {
  it('shows the service endpoint and API reference', () => {
    ...
    ).toHaveAttribute('href', 'https://docs.crew.ai/api-reference/datasets')
  })
