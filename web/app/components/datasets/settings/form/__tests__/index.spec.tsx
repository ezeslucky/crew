    ...
    <div data-testid="indexing-section">
      {!!currentDataset?.doc_form && (
        <>
          ...
          <a href="https://docs.crew.ai/use-crew/knowledge/create-knowledge/chunking-and-cleaning-text">
      ...
      {currentDataset?.provider !== 'external' && indexMethod && (
        <>
          ...
          <a href="https://docs.crew.ai/use-crew/knowledge/create-knowledge/setting-indexing-methods">
...
describe('Form', () => {
  ...
  describe('Save Functionality', () => {
    ...
    it('should show error when trying to save with empty name', async () => {
      const { toast } = await import('@crew/crew-ui/toast')
      render(<Form />)
