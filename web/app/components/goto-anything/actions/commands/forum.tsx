...
/**
 * Forum command - Opens crew community forum
 */
export const forumCommand: SlashCommandHandler<ForumDeps> = {
  name: 'forum',
  description: 'Open Crew community forum',
  mode: 'direct',

  // Direct execution function
  execute: () => {
    const url = 'https://forum.crew.ai'
    ...
    return [
      {
        ...
        data: { command: 'navigation.forum', args: { url: 'https://forum.crew.ai' } },
      },
    ]
  },
  ...
  register(_deps: ForumDeps) {
    registerCommands({
      'navigation.forum': async (args) => {
        const url = args?.url || 'https://forum.crew.ai'
        window.open(url, '_blank', 'noopener,noreferrer')
      },
    })
  },
