import type { AppPartial } from '@crew/contracts/api/console/apps/types.gen'
import type { DatasetListItemResponse } from '@crew/contracts/api/console/datasets/types.gen'
