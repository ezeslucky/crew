...
import type { AutocompleteChangeEventDetails } from '@crew/crew-ui/autocomplete'
...
import {
  ...
  AutocompleteList,
  AutocompleteStatus,
} from '@crew/crew-ui/autocomplete'
import {
  Dialog,
  DialogBackdrop,
  DialogCloseButton,
...
function GotoAnythingDialog() {
  ...
  const { canInstallPlugin, currentCrewVersion } = useWorkspacePluginInstallPermission()
