        ...
        <div className="relative">
          ...
          <div className="flex flex-col items-center gap-4 py-8">
            {systemFeatures.branding.enabled && systemFeatures.branding.workspace_logo ? (
              ...
              <CrewLogo size="large" className="mx-auto" />
            )}
            ...
            <div className="flex flex-col items-center gap-2 text-center text-xs font-normal text-text-secondary">
              ...
              <div className="text-text-accent">
                {IS_CE_EDITION ? (
                  <Link
                    href="https://github.com/ezeslucky/crew/blob/main/LICENSE"
                    target="_blank"
                  ...
                  <>
                    <Link href="https://crew.ai/privacy" target="_blank" rel="noopener noreferrer">
                      Privacy Policy
                    </Link>
                    ,&nbsp;
                    <Link href="https://crew.ai/terms" target="_blank" rel="noopener noreferrer">
                      Terms of Service
                    </Link>
                  </>
                )}
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex shrink-0 items-center">
              <Button className="mr-2" size="small">
                <Link
                  href="https://github.com/ezeslucky/crew/releases"
                  target="_blank"
                  rel="noopener noreferrer"
                >
