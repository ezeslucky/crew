...
} from '@crew/contracts/api/console/api-based-extension/types.gen'
...
export function ApiBasedExtensionModal(props: ApiBasedExtensionModalProps) {
  ...
  const apiEndpointLabel = t(($) => $['apiBasedExtension.modal.apiEndpoint.title'], {
    ns: 'common',
  })
      ...
      >
        ...
        <Form<ApiBasedExtensionPayload> className="grid gap-4 pt-2" onFormSubmit={handleSubmit}>
          ...
          <Field name="api_endpoint">
            ...
            <FieldDescription>
              <a
                href={docLink('/use-crew/workspace/api-extension/api-extension')}
                target="_blank"
