...
describe('DataSourcePage Component', () => {
  const mockProviders: DataSourceAuth[] = [
    {
      ...
      icon: 'icon-1',
      name: 'Crew Source',
      label: { en_US: 'Crew Source', zh_Hans: 'zh_hans_crew_source' },
      description: { en_US: 'Crew Description', zh_Hans: 'zh_hans_crew_description' },
      credentials_list: [],
    },
    {
      author: 'Partner',
  ...
  describe('Initial View Rendering', () => {
    it('should render an empty view when no data is available and marketplace is disabled', () => {
      ...
      expect(screen.queryByText('Crew Source')).not.toBeInTheDocument()
