...
describe('IntegrationsPage', () => {
  ...
  it('renders the tools header for tool sections', () => {
    ...
    expect(screen.getByRole('link', { name: /common\.modelProvider\.learnMore/i })).toHaveAttribute(
      'href',
      'https://docs.crew.ai/en/self-host/use-crew/workspace/tools',
    )
  })
  ...
  it('renders the mcp header for the mcp section', () => {
    ...
    expect(screen.getByRole('link', { name: /common\.modelProvider\.learnMore/i })).toHaveAttribute(
      'href',
      'https://docs.crew.ai/en/self-host/use-crew/workspace/tools#mcp',
    )
  ...
  it('renders the custom tool header for the custom tool section', () => {
    ...
    expect(screen.getByRole('link', { name: /common\.modelProvider\.learnMore/i })).toHaveAttribute(
      'href',
      'https://docs.crew.ai/en/self-host/use-crew/workspace/tools#swagger-api',
    )
    expect(screen.queryByText('common.toolsPage.description')).not.toBeInTheDocument()
  })
  ...
  it.each([
    [
      ...
      'https://docs.crew.ai/en/develop-plugin/dev-guides-and-walkthroughs/datasource-plugin#data-source-plugin-types',
    ],
  ...
  it('renders the custom endpoint header with toolbar and docs link', () => {
    ...
    expect(screen.getByRole('link', { name: /common\.modelProvider\.learnMore/i })).toHaveAttribute(
      'href',
      'https://docs.crew.ai/en/develop-plugin/dev-guides-and-walkthroughs/endpoint',
    )
    expect(screen.queryByText('common.toolsPage.description')).not.toBeInTheDocument()
  })
  ...
  it.each([
    [
      ...
      'https://docs.crew.ai/en/develop-plugin/dev-guides-and-walkthroughs/trigger-plugin',
    ],
    [
      'extension',
      'plugin.categorySingle.extension',
      'common.extensionPage.description',
      'https://docs.crew.ai/en/self-host/use-crew/workspace/api-extension/api-extension',
    ],
    [
      'agent-strategy',
      'plugin.categorySingle.agent',
      'common.agentStrategyPage.description',
      'https://docs.crew.ai/en/develop-plugin/dev-guides-and-walkthroughs/agent-strategy-plugin',
    ],
  ] as const)('renders the %s header with a docs link', (section, title, description, href) => {
    renderIntegrationsPage({ section })
  ...
  it('renders the workflow as tool header with a docs link', () => {
    ...
    expect(screen.getByRole('link', { name: /common\.modelProvider\.learnMore/i })).toHaveAttribute(
      'href',
      'https://docs.crew.ai/en/self-host/use-crew/workspace/tools#workflow',
    )
    expect(screen.queryByText('common.toolsPage.description')).not.toBeInTheDocument()
  })
