...
import { Collapsible, CollapsiblePanel, CollapsibleTrigger } from '@crew/crew-ui/collapsible'
...
const headerDescriptionDocPaths = {
  provider: '/use-crew/workspace/model-providers',
  'data-source':
    '/develop-plugin/dev-guides-and-walkthroughs/datasource-plugin#data-source-plugin-types',
  builtin: '/use-crew/workspace/tools',
  'custom-tool': '/use-crew/workspace/tools#swagger-api',
  'workflow-tool': '/use-crew/workspace/tools#workflow',
  mcp: '/use-crew/workspace/tools#mcp',
  ...
  extension: '/use-crew/workspace/api-extension/api-extension',
