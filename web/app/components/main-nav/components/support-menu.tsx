import { DropdownMenuItem, DropdownMenuLinkItem } from '@crew/crew-ui/dropdown-menu'
        ...
        >
          <MenuItemContent
            ...
            trailing={
              <span
                aria-hidden
                className="max-w-30 shrink-0 truncate px-1 system-xs-semibold-uppercase text-saas-crew-blue-accessible"
              >
