...
import { Popover, PopoverContent, PopoverTitle, PopoverTrigger } from '@crew/crew-ui/popover'
        ...
        <div className="flex items-center justify-center gap-1.5 border-t border-divider-subtle py-2 pr-2.5 pl-2">
          ...
          {showPlanAction && (
            <button
              ...
              className="max-w-30 shrink-0 truncate px-1 system-xs-semibold-uppercase text-saas-crew-blue-accessible transition-colors hover:text-saas-crew-blue-static-hover focus-visible:inset-ring-2 focus-visible:inset-ring-state-accent-solid focus-visible:outline-hidden"
              onClick={onPlanClick}
            >
              {planActionLabel}
            </button>
