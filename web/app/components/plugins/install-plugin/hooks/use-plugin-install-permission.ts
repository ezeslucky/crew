...
const usePluginInstallPermission = () => {
  ...
  const currentCrewVersion = usePluginInstallPermissionStore((state) => state.currentCrewVersion)
...
export const useOptionalPluginInstallPermission = () => {
  ...
  const currentCrewVersion = useStore(store, (state) => state.currentCrewVersion)
