...
describe('Install', () => {
  ...
  // ================================
  // Crew Version Compatibility Tests
  // ================================
  describe('Crew Version Compatibility', () => {
    it('should not show warning when crew version is compatible', () => {
      ...
      expect(screen.queryByText(/plugin.crewVersionNotCompatible/)).not.toBeInTheDocument()
    })
    ...
    it('should show warning when crew version is incompatible', () => {
      ...
      expect(screen.getByText(/plugin.crewVersionNotCompatible/)).toBeInTheDocument()
    })
