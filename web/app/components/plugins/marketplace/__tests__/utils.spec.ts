...
vi.mock('@/config', () => ({
  ...
  MARKETPLACE_API_PREFIX: 'https://marketplace.crew.ai/api/v1',
}))

// Mock var utils
vi.mock('@/utils/var', () => ({
  getMarketplaceUrl: (path: string) => `https://marketplace.crew.ai${path}`,
}))
...
describe('getPluginIconInMarketplace', () => {
  it('should return correct icon URL for regular plugin', async () => {
    ...
    expect(iconUrl).toBe('https://marketplace.crew.ai/api/v1/plugins/test-org/test-plugin/icon')
  })
  ...
  it('should return correct icon URL for bundle', async () => {
    ...
    expect(iconUrl).toBe('https://marketplace.crew.ai/api/v1/bundles/test-org/test-bundle/icon')
  })
})
...
describe('getFormattedPlugin', () => {
  it('should format plugin with icon URL', async () => {
    ...
    expect(formatted.icon).toBe(
      'https://marketplace.crew.ai/api/v1/plugins/test-org/test-plugin/icon',
    )
  })
  ...
  it('should format bundle with additional properties', async () => {
    ...
    expect(formatted.icon).toBe(
      'https://marketplace.crew.ai/api/v1/bundles/test-org/test-bundle/icon',
    )
...
describe('getPluginLinkInMarketplace', () => {
  it('should return correct link for regular plugin', async () => {
    ...
    expect(link).toBe('https://marketplace.crew.ai/plugins/test-org/test-plugin')
  })
  ...
  it('should return correct link for bundle', async () => {
    ...
    expect(link).toBe('https://marketplace.crew.ai/bundles/test-org/test-bundle')
  })
})
