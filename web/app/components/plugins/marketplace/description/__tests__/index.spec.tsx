...
describe('Description', () => {
  ...
  it('renders the marketplace message in non-Chinese order', () => {
    ...
    expect(screen.getByRole('heading', { level: 2 })).toHaveTextContent(
      /^marketplace\.discovercategory\.models,category\.tools,category\.datasources,category\.triggers,category\.agents,category\.extensionsmarketplace\.andcategory\.bundlesoperation\.inmarketplace\.crewMarketplace$/,
    )
  })
  ...
  it('renders the marketplace message in Simplified Chinese order', () => {
    ...
    expect(screen.getByRole('heading', { level: 2 })).toHaveTextContent(
      /^operation\.inmarketplace\.crewMarketplacemarketplace\.discovercategory\.models,category\.tools,category\.datasources,category\.triggers,category\.agents,category\.extensionsmarketplace\.andcategory\.bundles$/,
    )
  })
