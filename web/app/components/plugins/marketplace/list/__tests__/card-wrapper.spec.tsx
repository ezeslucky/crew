...
const plugin = {
  ...
  introduction: 'Intro',
  repository: 'https://github.com/ezeslucky/plugin-a',
...
describe('CardWrapper', () => {
  ...
  it('links the card to its marketplace detail when explicitly enabled', () => {
    ...
    expect(screen.getByRole('link')).toHaveAttribute('href', '/detail/crew/plugin-a')
  })
  ...
  it('opens marketplace detail from the detail action', () => {
    ...
    expect(openSpy).toHaveBeenCalledWith(
      '/marketplace/crew/plugin-a?language=en-US&theme=system',
      '_blank',
      'noopener,noreferrer',
    )
  })
