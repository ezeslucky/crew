...
const createMockGitHubPayload = (
  ...
  originalPackageInfo: {
    ...
    repo: 'owner/repo',
    version: '1.0.0',
    package: 'test-package.crewpkg',
    releases: [
      {
        tag_name: 'v1.0.0',
        assets: [
          { id: 1, name: 'plugin.crewpkg', browser_download_url: 'https://github.com/test' },
        ],
      },
      {
        tag_name: 'v2.0.0',
        assets: [
          { id: 2, name: 'plugin.crewpkg', browser_download_url: 'https://github.com/test' },
        ],
      },
    ],
  },
