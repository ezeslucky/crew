...
vi.mock('@crew/crew-ui/popover', async () => await import('@/__mocks__/base-ui-popover'))
...
vi.mock('@crew/crew-ui/alert-dialog', () => ({
  AlertDialog: ({
    children,
    open,
    onOpenChange,
...
vi.mock('@/hooks/use-api-access-url', () => ({
  useDatasetApiAccessUrl: () => 'https://api.crew.ai/v1/datasets/test-dataset-id',
}))
  ...
  describe('Popup (popup.tsx)', () => {
    ...
    describe('API Reference Link', () => {
      it('should render API reference link with correct href', () => {
        ...
        expect(apiLink).toHaveAttribute('href', 'https://api.crew.ai/v1/datasets/test-dataset-id')
