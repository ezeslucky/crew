...
function TourCompletionPrompt({
  ...
  return (
    ...
    >
      <span
        aria-hidden
        className="mb-3 flex size-5 items-center justify-center rounded-full border-2 border-saas-crew-blue-inverted text-saas-crew-blue-inverted"
      >
          ...
          return (
            <div
              ...
              className={cn(
                ...
                active ? 'bg-saas-crew-blue-inverted' : 'bg-components-slider-track',
              )}
            />
          )
        })}
  ...
  if (completed) {
    return (
      <button
        ...
        disabled={disabled}
        className="flex size-[18px] shrink-0 items-center justify-center rounded-full bg-saas-crew-blue-accessible text-text-primary-on-surface outline-hidden hover:bg-saas-crew-blue-inverted focus-visible:ring-2 focus-visible:ring-state-accent-solid disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:bg-saas-crew-blue-accessible"
