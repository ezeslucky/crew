...
export const STEP_BY_STEP_TOUR_TARGETS = {
  ...
  studioEmptyLearnCrew: 'step-by-step-tour-studio-empty-learn-crew',
...
> = {
  studioEmpty: [
    ...
    {
      id: 'studio.empty.learn_crew',
      taskId: 'studio',
      target: STEP_BY_STEP_TOUR_TARGETS.studioEmptyLearnCrew,
      title: 'stepByStepTour.guides.studio.empty.learnCrew.title',
      description: 'stepByStepTour.guides.studio.empty.learnCrew.description',
      learnMoreLabel: 'stepByStepTour.learnMore',
      primaryActionLabel: 'stepByStepTour.guides.primaryActionLabel',
      optional: true,
    },
