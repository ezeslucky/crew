import type { AgentInviteOptionResponse } from '@crew/contracts/api/console/agent/types.gen'
import type { ComboboxChangeEventDetails } from '@crew/crew-ui/combobox'
