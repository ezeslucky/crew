  ...
  it('should render URLs in descriptions as external links', () => {
    render(
      <ToolFormItem
        ...
        schema={createSchema({
          tooltip: {
            en_US: 'Visit https://docs.crew.ai/tools for docs',
            zh_Hans: 'Visit https://docs.crew.ai/tools for docs',
          },
        })}
        value={{}}
        onChange={vi.fn()}
    ...
    const link = screen.getByRole('link', { name: 'https://docs.crew.ai/tools' })
    expect(link)!.toHaveAttribute('href', 'https://docs.crew.ai/tools')
    expect(link)!.toHaveAttribute('target', '_blank')
    expect(link)!.toHaveAttribute('rel', 'noopener noreferrer')
    expect(link.parentElement)!.toHaveTextContent('Visit https://docs.crew.ai/tools for docs')
  })
