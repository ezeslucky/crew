...
/**
 * Workflow-as-tool and some internal APIs store Crew VarType strings (e.g. `array[string]`)
 ...
 */
const resolveCrewCompactTypeString = (typeStr: string): VarType | undefined => {
...
export const resolveVarType = (
  ...
  if (schema && typeof schema.type === 'string') {
    const compact = resolveCrewCompactTypeString(schema.type)
