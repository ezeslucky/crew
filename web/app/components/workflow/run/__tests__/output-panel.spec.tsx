...
type FileOutput = FileResponse & { crew_model_identity: '__crew__file__' }
...
describe('OutputPanel', () => {
  ...
  it('renders a plain text output as markdown', () => {
    render(<OutputPanel outputs={{ answer: 'Hello Crew' }} />)

    expect(screen.getByTestId('markdown')).toHaveTextContent('Hello Crew')
  })
