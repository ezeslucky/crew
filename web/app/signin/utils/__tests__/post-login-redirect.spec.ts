...
describe('post-login redirect utilities', () => {
  ...
  it('should allow a trusted Crew absolute query target', () => {
    const searchParams = new URLSearchParams({
      redirect_url: 'https://docs.eu.crew.ai/getting-started',
    })
    ...
    ).toEqual({ kind: 'absolute', href: 'https://docs.eu.crew.ai/getting-started' })
  })
