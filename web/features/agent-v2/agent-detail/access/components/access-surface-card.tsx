...
export function AccessSurfaceCard({
  ...
  return (
    <article
      ...
      className="rounded-xl border border-components-panel-border bg-components-panel-bg shadow-xs"
    >
        ...
        <div className="mt-3">
          ...
          <div className="mt-1 flex h-8 min-w-0 items-center rounded-lg bg-components-input-bg-normal px-2">
            ...
            >
              <span
                aria-hidden
                className={cn(copied ? 'i-ri-check-line' : 'i-ri-file-copy-line', 'size-4')}
              />
            </Button>
            {endpointActions}
          </div>
