...
import { Dialog, DialogTrigger } from '@crew/crew-ui/dialog'
import {
  FileTreeBadge,
  FileTreeGuide,
  FileTreeIcon,
  FileTreeLabel,
} from '@crew/crew-ui/file-tree'
    ...
    >
      <p className="body-xs-regular text-text-secondary">
        <Trans
          ...
          ns="agentV2"
          components={{
            docLink: <DocsLink href={docLink('/use-crew/build/new-agent/build#the-build-note')} />,
          }}
        />
      </p>
    </Infotip>
