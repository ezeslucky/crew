...
import type { AgentKnowledgeDatasetConfig } from '@crew/contracts/api/console/agent/types.gen'
...
import { RadioGroup, RadioItem } from '@crew/crew-ui/radio'
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-2 px-4 pb-4">
        ...
        <a
          href={docLink('/use-crew/knowledge/create-knowledge/setting-indexing-methods')}
          target="_blank"
