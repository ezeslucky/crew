...
import type { PostAgentByAgentIdConfigSkillsUploadResponse } from '@crew/contracts/api/console/agent/types.gen'
import type { PostAppsByAppIdAgentConfigSkillsUploadResponse } from '@crew/contracts/api/console/apps/types.gen'
