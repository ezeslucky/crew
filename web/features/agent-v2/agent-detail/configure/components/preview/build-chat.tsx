...
function AgentBuildChatEmptyState() {
  ...
  return (
    <>
      <div className="crew-blue-glass-surface relative flex h-[50px] w-12 items-center justify-center rounded-xl p-2">
        ...
        <span
          aria-hidden
          className="absolute i-ri-hammer-line size-5 text-saas-crew-blue-inverted"
        />
      </div>
