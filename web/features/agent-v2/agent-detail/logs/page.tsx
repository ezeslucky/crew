...
import type { AgentLogConversationItemResponse } from '@crew/contracts/api/console/agent/types.gen'
...
import { Pagination } from '@crew/crew-ui/pagination'
      ...
      <header className="h-26.5 shrink-0 px-6 pt-3 pb-2">
        <div className="min-w-0">
          ...
          <p className="mt-1 flex min-w-0 flex-wrap items-center gap-x-0.5 system-xs-regular text-text-tertiary">
            ...
            <a
              href={docLink('/use-crew/monitor/logs')}
              target="_blank"
              rel="noreferrer"
