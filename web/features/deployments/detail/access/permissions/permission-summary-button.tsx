...
import { AccessSubjectType } from '@crew/contracts/enterprise/types.gen'
import { cn } from '@crew/crew-ui/cn'
import { useTranslation } from 'react-i18next'
import { permissionIcon } from './access-policy'
...
export function PermissionSummaryButton({
  ...
  return (
    <button
      type="button"
      disabled={disabled}
      aria-label={t(($) => $['access.permissions.editAriaLabel'], {
