(()=>{let t="crewChatbotConfig",m="crew-chatbot-bubble-button",h="crew-chatbot-bubble-window",y=window[t],l=!1,c=`
    position: absolute;
    display: flex;
    flex-direction: column;
    justify-content: space-between;
    top: unset;
    right: var(--${m}-right, 1rem); /* Align with crew-chatbot-bubble-button. */
    bottom: var(--${m}-bottom, 1rem); /* Align with crew-chatbot-bubble-button. */
    left: unset;
    width: 24rem;
