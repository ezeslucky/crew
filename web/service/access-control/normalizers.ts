...
type GeneratedAccessMatrixItem =
  import('@crew/contracts/api/console/workspaces/types.gen').AccessMatrixItem
type GeneratedAccessPolicy = import('@crew/contracts/api/console/workspaces/types.gen').AccessPolicy
type GeneratedAccessPolicyAccount =
  import('@crew/contracts/api/console/workspaces/types.gen').AccessPolicyAccount
type GeneratedAccessPolicyRole =
  import('@crew/contracts/api/console/workspaces/types.gen').AccessPolicyRole
type GeneratedAppAccessMatrix =
  import('@crew/contracts/api/console/workspaces/types.gen').AppAccessMatrix
type GeneratedDatasetAccessMatrix =
  import('@crew/contracts/api/console/workspaces/types.gen').DatasetAccessMatrix
type GeneratedRbacRole = import('@crew/contracts/api/console/workspaces/types.gen').RbacRole
type GeneratedRbacRoleAccount =
  import('@crew/contracts/api/console/workspaces/types.gen').RbacRoleAccount
type GeneratedResourceOpenScope =
  import('@crew/contracts/api/console/workspaces/types.gen').RbacResourceWhitelistScope
type GeneratedResourceUserAccessPoliciesResponse =
  import('@crew/contracts/api/console/workspaces/types.gen').ResourceUserAccessPoliciesResponse
