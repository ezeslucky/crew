import type { AgentAppPagination } from '@crew/contracts/api/console/agent/types.gen'
import type { ApiBasedExtensionResponse } from '@crew/contracts/api/console/api-based-extension/types.gen'
import type { TagResponse as Tag, TagType } from '@crew/contracts/api/console/tags/types.gen'
import type { consoleRouterContract } from '@crew/contracts/console'
import type {
  GetReleaseResponse,
...
import { marketplaceRouterContract } from '@crew/contracts/marketplace'
...
function getMarketplaceHeaders() {
  return new Headers({
    'X-Crew-Version': !IS_MARKETPLACE ? APP_VERSION : '999.0.0',
  })
}
