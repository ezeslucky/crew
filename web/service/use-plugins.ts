import type { PluginInstallationItemResponse } from '@crew/contracts/api/console/workspaces/types.gen'
import type {
  PluginInfoFromMarketPlace,
  PluginsFromMarketplaceByInfoResponse,
  PluginsFromMarketplaceResponse,
} from '@crew/contracts/marketplace'
...
const normalizePluginDeclaration = (plugin: PluginInstallationItemResponse): PluginDeclaration => {
  ...
  return {
    ...
    meta: {
      ...
      minimum_crew_version: getString(declaration.meta.minimum_crew_version) || undefined,
    },
