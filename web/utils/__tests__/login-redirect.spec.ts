...
describe('resolveLoginRedirectTarget', () => {
  describe('allowed targets', () => {
    ...
    it.each([
      ['https://crew.ai', 'https://crew.ai/'],
      ['https://cloud.crew.ai/apps', 'https://cloud.crew.ai/apps'],
      [
        'https://docs.eu.crew.ai/path?from=login#section',
        'https://docs.eu.crew.ai/path?from=login#section',
      ],
      ['https://crew.ai:443/apps', 'https://crew.ai/apps'],
    ])('should allow the trusted Crew target %s', (raw, expected) => {
  ...
  describe('legacy encoding compatibility', () => {
    it.each([
      ...
      [
        'https%3A%2F%2Fcloud.crew.ai%2Fapps',
        { kind: 'absolute', href: 'https://cloud.crew.ai/apps' },
      ],
  ...
  describe('rejected targets', () => {
    it.each([
      ...
      'https://google.com',
      'http://cloud.crew.ai',
      'https://cloud.crew.ai:444/apps',
      'https://crew.ai.evil.example',
      'https://evilcrew.ai',
      'https://crew.ai@evil.example',
      'https://user:password@crew.ai',
      'javascript:alert(1)',
      ...
      '/\\evil.example',
      '/path\\to\\resource',
      'https://cloud.crew.ai//evil.example',
